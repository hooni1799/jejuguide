...
/* 맛집 — 사용자가 네이버 지도에 저장한 목록 기준 (실제 상호명·주소) */
const FOODS = [
  { name:'흑본오겹 함덕점', region:'함덕', menu:'흑돼지 오겹살', cat:'돼지고기구이', addr:'조천읍 함덕리 3039-1', emoji:'🥓', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 흑돼지 구이 전문점. 등산 후 단백질 보충 코스로 좋아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕'] },
  { name:'함덕고갈치', region:'함덕', menu:'갈치조림 · 갈치구이', cat:'한식', addr:'조천읍 함덕리 1252-42 2층', emoji:'🐟', color:'#E3F4F1',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 갈치조림 전문점.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕'] },
  { name:'고집돌우럭 제주함덕점', region:'함덕', menu:'우럭조림 정식', cat:'향토음식', addr:'조천읍 함덕리 1020-2 2층', emoji:'🍲', color:'#EAF4EE',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 향토음식점. 우럭조림 코스 정식으로 알려져 있어요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕'] },
  { name:'대풍미락 함덕본점', region:'함덕', menu:'생선회', cat:'생선회', addr:'조천읍 함덕리 1028', emoji:'🐟', color:'#E3F4F1',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 생선회 전문점. 사진상 오션뷰 좌석이 있는 것으로 보여요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','오션뷰'] },
  { name:'제주순풍해장국 함덕점', region:'함덕', menu:'해장국', cat:'해장국', addr:'조천읍 함덕리 4144 1층', emoji:'🍚', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 해장국집. 이른 아침이나 등산 전날 든든한 한 끼로 좋아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','해장국'] },
  { name:'함덕용두네해장국', region:'함덕', menu:'해장국', cat:'해장국', addr:'조천읍 함덕리 1002-47', emoji:'🍚', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 해장국집. 등산일 아침 식사 후보로 좋아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','해장국'] },
  { name:'곱들락 함덕흑돼지', region:'함덕', menu:'흑돼지 구이', cat:'육류·고기요리', addr:'조천읍 함덕리 951-1 101호', emoji:'🥩', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 흑돼지 고깃집.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','고기'] },
  { name:'두툼한고기돈돼지 제주 함덕점', region:'함덕', menu:'돼지고기구이', cat:'돼지고기구이', addr:'조천읍 함덕리 960-9', emoji:'🥩', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 돼지고기 구이집. 사진상 "착한가격업소" 인증이 붙어있어요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','가성비'] },
  { name:'저팔계깡통연탄구이 함덕흑돼지', region:'함덕', menu:'연탄 돼지고기구이', cat:'돼지고기구이', addr:'조천읍 함덕리 1271', emoji:'🥩', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 연탄구이 흑돼지집.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','고기'] },
  { name:'계절식탁함덕점', region:'함덕', menu:'한식 코스', cat:'한식', addr:'조천읍 함덕리 1004-41 2층', emoji:'🍽️', color:'#EAF4EE',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 한식당. 사진상 오션뷰 좌석과 회 플레이팅이 보여요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','오션뷰'] },
  { name:'여기고씨네 제주함덕점', region:'함덕', menu:'생선회', cat:'생선회', addr:'조천읍 함덕리 1252-9', emoji:'🐟', color:'#E3F4F1',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 횟집.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕','횟집'] },
  { name:'함덕골목 본점', region:'함덕', menu:'한식', cat:'한식', addr:'조천읍 함덕리 1209-13', emoji:'🍜', color:'#EAF4EE',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 함덕 한식당.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','함덕'] },
  { name:'달마야해물탕 북촌', region:'북촌', menu:'해물탕', cat:'육류·고기요리', addr:'조천읍 북촌리 1363-1', emoji:'🦀', color:'#E3F4F1',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 북촌리 해물탕집. 함덕–김녕 이동 중 들르기 좋은 위치예요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','북촌'] },
  { name:'명진전복', region:'세화·구좌', menu:'전복돌솥밥', cat:'전복요리', addr:'구좌읍 평대리 515-28', emoji:'🐚', color:'#EAF4EE',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 평대리 전복요리 전문점. 세화·평대 해안도로 스쿠터 코스와 딱 맞아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','스쿠터 코스'] },
  { name:'공천포식당', region:'남원', menu:'한치물회 · 전복물회', cat:'해물·생선요리', addr:'남원읍 신례리 27-5', emoji:'🥣', color:'#E3F4F1',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 남원읍 물회 전문점. 마지막 날 점심으로 예정된 코스!',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','7/20 점심'] },
  { name:'해이당 제주남원본점', region:'남원', menu:'한식', cat:'한식', addr:'남원읍 남원리 128-9 2층', emoji:'🍽️', color:'#EAF4EE',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 남원 한식당. 사진상 한상차림 스타일로 보여요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','남원'] },
  { name:'유달식당', region:'서귀포', menu:'중식', cat:'중식당', addr:'서귀포시 하효동 314', emoji:'🥡', color:'#FFF3E8',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 서귀포 하효동 중식당. 쇠소깍·공천포 방향 이동 중 들르기 좋아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','서귀포'] },
  { name:'우진해장국', region:'제주시', menu:'고사리육개장', cat:'향토음식', addr:'삼도이동 831', emoji:'🍚', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 제주시 향토음식점. 고사리육개장으로 잘 알려진 곳이에요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','제주시 노포'] },
  { name:'명도암 정담김밥', region:'제주시', menu:'김밥', cat:'김밥', addr:'봉개동 848-12', emoji:'🍙', color:'#E3F4F1',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 봉개동 김밥집. 이동 중 간단히 포장하기 좋아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','제주시','포장'] },
  { name:'교래흑돼지 본점', region:'교래·산간', menu:'흑돼지 구이', cat:'돼지고기구이', addr:'조천읍 교래리 216-1', emoji:'🥩', color:'#FFE4D6',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 교래리 흑돼지 구이 전문점. 산간 드라이브 코스에서 들르기 좋아요.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','교래'] },
  { name:'성미가든', region:'교래·산간', menu:'닭요리', cat:'닭요리', addr:'조천읍 교래리 532', emoji:'🍗', color:'#EAF4EE',
    hours:'영업시간 확인 필요', brk:'확인 필요', price:'가격대 확인 필요',
    why:'저장해두신 교래리 닭요리 전문점.',
    wait:'확인 필요', rsv:'확인 필요', tags:['저장 목록','교래'] },
];

/* 카페 — 무드별 (영업 정보는 변동 가능, ★는 저장 목록 기준 실존 확인) */
const CAFES = [
  { name:'델문도', region:'함덕', mood:['오션뷰','감성'], emoji:'🌊', color:'#E3F4F1',
    desc:'함덕 바다 위에 떠 있는 듯한 카페. 창밖이 전부 에메랄드빛 — 아침 커피 명당.',
    pick:'함덕 아침 산책 후 모닝커피' },
  { name:'오드랑베이커리 함덕점', region:'함덕', mood:['디저트'], emoji:'🥐', color:'#FFF3E8',
    desc:'저장해두신 함덕 베이커리. 등산 전날 행동식이나 아침 빵 챙기기 좋아요.',
    pick:'한라산 등반 전날 행동식 구매', addr:'조천읍 함덕리 270-1' },
  { name:'카페공작소', region:'세화·구좌', mood:['오션뷰','감성'], emoji:'🪑', color:'#FFF3E8',
    desc:'저장해두신 세화 카페. 통창 너머 바다가 보이는 곳으로 스쿠터 코스 휴식 포인트로 좋아요.',
    pick:'스쿠터 코스 카페 스탑', addr:'구좌읍 세화리 1477-4 1층' },
  { name:'카페모알보알 제주점', region:'김녕', mood:['오션뷰','감성'], emoji:'🌅', color:'#EAF4EE',
    desc:'저장해두신 김녕 카페. 노을 사진이 예쁘게 나오는 것으로 보여요.',
    pick:'스쿠터 코스 중 노을 감상', addr:'구좌읍 김녕리 6159' },
  { name:'so much more', region:'북촌', mood:['감성','디저트'], emoji:'🍰', color:'#EEF0EF',
    desc:'저장해두신 북촌 카페. 아늑한 실내와 디저트가 눈에 띄어요.',
    pick:'함덕–김녕 이동 중 티타임', addr:'조천읍 북촌리 487 1F' },
  { name:'포레스텔라 인 제주', region:'교래·산간', mood:['브런치','감성'], emoji:'🥞', color:'#FFF3E8',
    desc:'저장해두신 송당리 브런치 카페. 산간 드라이브 코스에서 여유로운 브런치로 좋아요.',
    pick:'느긋한 브런치 타임', addr:'구좌읍 송당리 2653-4 1층' },
...
const SCOOTER = {
  ...
  stops:[
    { name:'함덕 (출발)', sub:'09:30 출발 · 대여점에서 브리핑', tip:'저장해두신 "씽씽대여샵 함덕점" 등 함덕 스쿠터 대여점에서 출발 전 타이어 공기압·브레이크·연료 게이지 확인', leg:null },
    ...
    <div class="food-card reveal">
      <div class="food-main">
        ...
        <div class="food-info">
          ...
          <div class="f-menu">${f.menu} <span class="f-cat">· ${f.cat}</span></div>
          <div class="f-desc">${f.why}</div>
        </div>
      </div>
      <div class="food-meta">
        <span class="f-addr"><i data-lucide="map-pin"></i>${f.addr}</span>
      </div>
      <div class="food-meta">
      ...
      <div class="food-meta">
        <span><i data-lucide="users"></i>웨이팅 ${f.wait}</span>
